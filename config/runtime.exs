...
#
#     PHX_SERVER=true bin/travel_agency start
#
...
if config_env() == :prod do
  ...
  config :travel_agency, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :travel_agency, TravelAgency.Mailer,
