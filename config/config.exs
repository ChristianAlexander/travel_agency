...
config :travel_agency, TravelAgencyWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TravelAgencyWeb.ErrorHTML, json: TravelAgencyWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TravelAgency.PubSub,
  live_view: [signing_salt: "peJtnqTB"]
...
config :travel_agency, TravelAgency.Mailer, adapter: Swoosh.Adapters.Local
