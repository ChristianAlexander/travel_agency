defmodule TravelAgency.Chat.Message do
  use Ash.Resource,
    otp_app: :travel_agency,
    domain: TravelAgency.Chat,
    extensions: [AshOban],
  ...
  oban do
    triggers do
      trigger :respond do
        actor_persister TravelAgency.AiAgentActorPersister
        action :respond
        queue :chat_responses
        lock_for_update? false
        scheduler_cron false
        worker_module_name TravelAgency.Chat.Message.Workers.Respond
        scheduler_module_name TravelAgency.Chat.Message.Schedulers.Respond
  ...
  actions do
    ...
    create :create do
      ...
      change TravelAgency.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change TravelAgency.Chat.Message.Changes.Respond
    end
  ...
  pub_sub do
    module TravelAgencyWeb.Endpoint
    prefix "chat"
  ...
  attributes do
    ...
    attribute :source, TravelAgency.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, TravelAgency.Chat.Conversation do
      public? true
      allow_nil? false
    end
